...
extern REAL f_bobyqa(const INTEGER n, const REAL *x, void *data);

extern result_eigen run_bobyqa(const vec_bounds bounds, const dyn_vector x, const INTEGER maxfun, function<double(dyn_vector x)> *f);
