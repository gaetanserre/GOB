...
#include "optimizers/particles/common-noise/SMD/SMD_PSO.hh"

void SMD_PSO::set_stop_criterion(double stop_criterion)
{
...
result_eigen SMD_PSO::minimize(function<double(dyn_vector)> f)
{
